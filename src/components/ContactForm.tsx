  ...
  const formContent = (
    ...
    >
      <div className="space-y-6">
        {isHero && (
          <div className="mb-2">
            <h3 className="text-3xl md:text-4xl font-heading font-bold text-foreground">Venda o seu imóvel com segurança e rapidez</h3>
            <p className="text-sm md:text-base mt-1">
              <span className="inline-block bg-[#C2855E] text-white px-3 py-1 rounded-full shadow-md">
                Lugares limitados para novos imóveis em destaque na plataforma.
              </span>
            </p>
          </div>
        )}
        ...
        >
          {isSubmitting ? "A enviar..." : "Quero anunciar o meu imóvel"}
        </Button>
    ...
    return (
      <div id="contato" className="w-full max-w-2xl ml-auto">
        ...
        <p className="text-[11px] md:text-xs text-center mt-3" style={{ color: "#FFFFFF" }}>
          Ao inscrever-se, garante prioridade no acesso a imóveis com condições especiais de lançamento.
        </p>
      </div>
    );
  }
