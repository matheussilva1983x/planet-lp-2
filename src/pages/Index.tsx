...
export default function Index() {
  ...
  return (
    <div className="min-h-screen">
          ...
          <div className="grid gap-10 md:grid-cols-2 items-center">
            <div className="text-center md:text-left">
              ...
              <h1 className="-mt-6 sm:-mt-8 md:-mt-10 text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-heading font-bold text-white mb-1 animate-fade-in leading-tight max-w-4xl">
                 Negociação simples, segura e sem complicações.
              </h1>
              <p
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <Button
            ...
            onClick={openLeadModal}
          >
            Quero anunciar o meu imóvel agora
          </Button>
        </div>
      </section>
          ...
          <div className="w-full max-w-lg bg-white rounded-2xl shadow-2xl p-6 md:p-8" onClick={(e) => e.stopPropagation()}>
            ...
            <form onSubmit={submitLead} className="space-y-4">
              ...
              <div>
                ...
                <input id="lead-phone" type="tel" value={leadPhone} onChange={(e) => setLeadPhone(e.target.value)} required className="w-full h-12 px-4 rounded-xl border border-gray-200 focus:outline-none focus:ring-2 focus:ring-[#C2855E] bg-white" placeholder="9XX XXX XXX" />
              </div>
              <div>
                <label htmlFor="lead-email" className="block text-sm font-medium mb-1" style={{ color: "#0D3A2E" }}>E-mail</label>
                <input id="lead-email" type="email" value={leadEmail} onChange={(e) => setLeadEmail(e.target.value)} required className="w-full h-12 px-4 rounded-xl border border-gray-200 focus:outline-none focus:ring-2 focus:ring-[#C2855E] bg-white" placeholder="nome@email.com" />
              </div>
      ...
      <WhatsAppFloat phone="5599999999999" message="Olá! Quero ajuda para anunciar o meu imóvel." />
    </div>
  );
}
